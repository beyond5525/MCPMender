...
const messages = {
  en: {
    ...
    "probe.previewDetail": "MCPulse will temporarily start the listed local servers or contact the listed remote endpoints, perform an MCP handshake, and then close every connection.",
    ...
    "cli.probeRunHint": "Review the list, then run: mcpulse probe --run",
  ...
  "zh-CN": {
    ...
    "probe.previewDetail": "MCPulse 将临时启动列表中的本地服务或连接远程地址，执行真实 MCP 握手，然后关闭全部连接。",
    ...
    "cli.probeRunHint": "确认列表后执行：mcpulse probe --run",
  ...
  ja: {
    ...
    "cli.probeRunHint": "一覧を確認後に実行：mcpulse probe --run",
